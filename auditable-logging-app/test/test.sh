...
curl -v "$server"/app/log -k -H "Content-Type: application/json" --data-binary '{ "objectID": 1, "timeStamp": "2023-07-19T10:12:34+00:00", "email": "bob@example.com" }'
res_post_item0=$(curl "$server"/app/log -X POST -H "Content-Type: application/json" --data-binary '{ "objectID": 1, "timeStamp": "2023-07-19T10:12:34+00:00", "email": "bob@example.com" }' -i --silent)
